...
function Layout() {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      {!isPDV && <Sidebar isOpen={isSidebarOpen} toggleSidebar={toggleSidebar} />}
      <div className={`flex-1 overflow-auto transition-all duration-300 ${isPDV ? "ml-0" : isSidebarOpen ? "ml-64" : "ml-20"}`}>
