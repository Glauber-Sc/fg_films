                  ...
                  <li key={p.id} className="rounded-lg border border-gray-200 p-4">
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <button
                        ...
                        className="inline-flex items-center justify-center rounded-md bg-gray-900 px-3 py-1.5 text-sm font-medium text-white shadow-sm hover:bg-black disabled:cursor-not-allowed disabled:opacity-60"
                      >
                        Adicionar
                      </button>
                    </div>
        ...
        <div className="overflow-hidden rounded-lg bg-white shadow">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 px-6 py-6">
            ...
            <button
              ...
              className="w-full rounded-md bg-gray-900 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-black disabled:cursor-not-allowed disabled:opacity-60"
            >
              Criar Orçamento
            </button>
          </form>
