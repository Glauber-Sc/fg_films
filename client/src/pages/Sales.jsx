...
// //   const referente =
// //     sale?.reference ||
// //     `${sale.productName ?? ""}${sale.quantity ? ` — ${sale.quantity}x` : ""}`;

// //   const importancia =
// //     sale?.amountInWords ||
// //     `${toBRL(sale.total)} (${sale.paymentMethods?.map(pm => `${pm.method}${pm.machine ? ` ${pm.machine}` : ""}: ${toBRL(pm.amount)}`).join(" | ") || "à vista"})`;
...
// // <style>
// //   /* Tamanho propositalmente fixo para bater o layout do talão */
// //   @page { size: A5 landscape; margin: 8mm; }
// //   body { margin: 0; padding: 0; background: #fff; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
// //   .sheet {
// //     width: 730px; height: 480px; margin: 0 auto; padding: 10px 12px;
// //     box-sizing: border-box; font-family: Arial, Helvetica, sans-serif; color:#000;
// //     border: 1px solid #000;
// //   }
// //   .topbar {
// //     display: flex; justify-content: space-between; align-items: center;
// //     border: 1px solid #000; border-radius: 10px; padding: 10px 14px; height: 78px;
// //   }
// //   .brand {
// //     display:flex; align-items:center; gap:10px;
// //   }
// //   .brand .logo {
// //     width: 80px; height: 20px; border-top: 3px solid #000; border-radius: 100px/30px; margin-top: 8px;
// //   }
...
// //   .recibo-row {
// //     display:flex; justify-content: space-between; align-items:center; margin: 12px 2px 6px;
// //   }
// //   .recibo-title { font-size: 28px; font-weight: 800; letter-spacing: 1px; }
// //   .rs-box {
// //     border: 1px solid #000; width: 90px; height: 54px; border-radius: 8px; position: relative;
// //   }
...
// //   .fill {
// //     border-bottom: 1px solid #000; height: 24px; display:flex; align-items:center;
// //     padding: 0 6px; font-size: 14px; overflow:hidden; white-space:nowrap; text-overflow:ellipsis;
// //   }
...
// //         <div>
// //           <h1>FG FILMS</h1>
// //           <div class="tag">acessórios automotivos</div>
// //           <div class="cnpj">CNPJ: 14.864.222/0001-67</div>
// //         </div>
// //       </div>
// //       <div class="right-box">
// //         <div class="phone">(91) 98241-6768<span class="bul"></span></div>
// //         <div class="addr">Rua 15 de Agosto, nº 552, Cruzeiro/Icoaraci — Belém/PA.</div>
// //       </div>
// //     </div>

// //     <!-- Título RECIBO + caixa R$ -->
// //     <div class="recibo-row">
// //       <div class="recibo-title">RECIBO</div>
// //       <div class="rs-box">
// //         <span class="label">R$</span>
// //         <div class="amount">${toBRL(sale.total)}</div>
// //       </div>
// //     </div>
...
// //       </div>
// //       <div class="city">Belém/PA, ${dia} de ${mes} de ${ano}</div>
// //     </div>
// //   </div>
// //   <script>
...
// //   return (
// //     <div>
// //       <PageHeader title="Vendas" actionButton={<ActionButton />} />
...
// //         <Card>
// //           <div className="text-center">
// //             <p className="text-sm font-medium text-gray-500">Valor Filtrado</p>
// //             <p className="text-3xl font-bold text-gray-800 mt-2">{formatCurrency(filteredTotal)}</p>
// //           </div>
// //         </Card>
// //       </div>
...
// //               className={`px-4 py-2 rounded-md ${
// //                 filter === "today" ? "bg-blue-600 text-white" : "bg-gray-200 text-gray-800 hover:bg-gray-300"
// //               }`}
// //             >
// //               Hoje
// //             </button>
...
// //               className={`px-4 py-2 rounded-md ${
// //                 filter === "month" ? "bg-blue-600 text-white" : "bg-gray-200 text-gray-800 hover:bg-gray-300"
// //               }`}
// //             >
// //               Este Mês
// //             </button>
...
// //                   <th className="table-header">Preço Unitário</th>
...
// //                       <td className="table-cell text-black-600 hover:text-black-800 text-sm font-medium">{sale.customerName}</td>
// //                       <td className="table-cell text-black-600 hover:text-black-800 text-sm font-medium">{sale.quantity}</td>
// //                       <td className="table-cell text-black-600 hover:text-black-800 text-sm font-medium">{formatCurrency(sale.unitPrice)}</td>
...
// /** Debounce simples para inputs/controles (se precisar no futuro) */
...
// /**
//  * Componente de paginação profissional com reticências, acessível e responsivo
//  */
...
//   // Paginação (sempre aplicada ao resultado filtrado)
...
//   // Sincroniza URL (?page=..&pageSize=..&filter=..)
//   useEffect(() => {
...
//   }, [safePage, pageSize, filter, searchParams, setSearchParams])
...
//         <div className="flex space-x-2">
//           <button onClick={() => setFilter("all")} className={`px-4 py-2 rounded-md ${filter === "all" ? "bg-red-600 text-white" : "bg-gray-200 text-gray-800 hover:bg-gray-300"}`}>Todas</button>
//           <button onClick={() => setFilter("today")} className={`px-4 py-2 rounded-md ${filter === "today" ? "bg-red-600 text-white" : "bg-gray-200 text-gray-800 hover:bg-gray-300"}`}>Hoje</button>
//           <button onClick={() => setFilter("month")} className={`px-4 py-2 rounded-md ${filter === "month" ? "bg-red-600 text-white" : "bg-gray-200 text-gray-800 hover:bg-gray-300"}`}>Este Mês</button>
//         </div>
...
//                 ) : (
//                   <tr>
//                     <td colSpan="8" className="table-cell text-center">Nenhuma venda encontrada</td>
//                   </tr>
//                 )}
//               </tbody>
//             </table>
...
//           {/* Footer de paginação com contagem e controles */}
