...
// // // import { formatCurrency } from "../utils/format";
// // // import { fetchSales } from "../services/api";
// // // import { paymentReceipt } from "../utils/paymentReceipt"; // <<< usa o helper que você construiu
// // // import logo from "../assets/img/logo.png"; // <<< para garantir a logo no recibo
...
// // //                       <td className="whitespace-nowrap px-6 py-4 text-sm">
// // //                         <button
// // //                           onClick={() => paymentReceipt(sale, { logoUrl: logo })} // <<< chama o helper
...
// //   // --- NORMALIZAÇÃO: agrupar itens por venda ---
...
// //       // se existir algum id de grupo, usa; senão, monta uma assinatura estável
...
// //   // --- Filtro por período + busca (em cima dos GRUPOS) ---
// //   const filteredSales = useMemo(() => {
// //     const today = new Date();
// //     today.setHours(0, 0, 0, 0);
// //     const firstDayOfMonth = new Date(today.getFullYear(), today.getMonth(), 1);
...
// //     // período
// //     let base = groupedSales.filter((sale) => {
// //       const saleDate = new Date(sale.date);
// //       if (filter === "today") return saleDate >= today;
// //       if (filter === "month") return saleDate >= firstDayOfMonth;
// //       return true;
...
// //     // busca por item / cliente / forma de pagamento
// //     const q = debouncedQuery.trim().toLowerCase();
// //     if (q) {
// //       base = base.filter((s) => {
...
// //     return base;
// //   }, [groupedSales, filter, debouncedQuery]);
...
// //   // Totais (em cima dos grupos)
// //   const totalSales = useMemo(() => groupedSales.reduce((sum, s) => sum + (s.total || 0), 0), [groupedSales]);
// //   const filteredTotal = useMemo(() => filteredSales.reduce((sum, s) => sum + (s.total || 0), 0), [filteredSales]);
...
// //                                 {
// //                                   ...sale,
// //                                   // helper aceita "payments" ou "paymentMethods";
...
//   // --- Agrupamento em cima do util (mais recentes primeiro) ---
