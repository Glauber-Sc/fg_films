// // Agrupa registros "item a item" do backend em vendas consolidadas (1 venda = N itens)
...
//     // Preferir ids de grupo se existirem (compatível com possíveis evoluções de backend)
//     const dateIso = new Date(s.date).toISOString();
//     const key =
//       s.saleGroupId ||
//       s.groupId ||
//       s.quoteId ||
//       `${s.customerId || ""}#${dateIso}#${pmSig(s.paymentMethods)}`;
